...
public class TestJSONWriter extends TestCase {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(TestJSONWriter.class);
     ...
     */
    public TestJSONWriter(String testName){
        super(testName);
    }
    ...
    public void test() throws IOException, NejiException {
        ...
        String expected = Variables.expectedJSON;

        InputStream in = new ByteArrayInputStream(strXML.getBytes("UTF-8"));
        p.add(new JSONWriter());
        OutputStream out = p.run(in).get(0);
        String outStr = out.toString();
        in.close();
        
//        logger.info("JSON Writer output: \n{}\n", outStr);
