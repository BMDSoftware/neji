...
import pt.ua.tm.neji.writer.PipeWriter;

/**
 * Testing class for PIPE format writer module.
 * 
 * @author jeronimo
 */
public class TestPIPEWriter extends TestCase {
     ...
     */
    public TestPIPEWriter(String testName){
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestPIPEWriter.class);
    }
    ...
    public void test() throws IOException, NejiException {
        ...
        String expected = Variables.expectedPIPE;

        InputStream in = new ByteArrayInputStream(strXML.getBytes("UTF-8"));
        p.add(new PipeWriter());
