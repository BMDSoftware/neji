 ...
 * @author jeronimo
 */
public class TestIeXMLWriter extends TestCase {
    
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(TestIeXMLWriter.class);

    /**
     * Create the test case.
     * @param testName 
     */
    public TestIeXMLWriter(String testName){
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestIeXMLWriter.class);
    }
    ...
    public void test() throws IOException, NejiException {
        ...
        String expected = Variables.expectedIeXML;

        InputStream in = new ByteArrayInputStream(strXML.getBytes("UTF-8"));
        p.add(new IeXMLWriter());
