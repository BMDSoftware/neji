...
import pt.ua.tm.neji.writer.PipeExtendedWriter;

/**
 * Testing class for PIPEXT format writer module.
 * 
 * @author jeronimo
 */
public class TestPIPEXTWriter extends TestCase {
     ...
     */
    public TestPIPEXTWriter(String testName){
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(TestPIPEXTWriter.class);
    }
    ...
    public void test() throws IOException, NejiException {
        ...
        String expected = Variables.expectedPIPEXT;

        InputStream in = new ByteArrayInputStream(strXML.getBytes("UTF-8"));
        p.add(new PipeExtendedWriter());
