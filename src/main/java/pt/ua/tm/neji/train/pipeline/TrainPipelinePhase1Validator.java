 ...
 * @author jeronimo
 */
public class TrainPipelinePhase1Validator implements PipelineValidator {
    ...
    // Attributes
    private TrainPipelinePhase1 trainPipeline;
    
    /**
     * Constructor.
     */
    public TrainPipelinePhase1Validator(TrainPipelinePhase1 trainPipeline) {
