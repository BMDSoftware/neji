 ...
 */
package pt.ua.tm.neji.train.featuresextractor;
 ...
 * @author jeronimo
 */
public class DefaultFeaturesExtractor extends BaseFeaturesExtractor {
    ...
    /**
     * Constructor.
     * @param config features to use at training.
     * @throws NejiException 
     */
    public DefaultFeaturesExtractor(ModelConfig config) throws NejiException {
     ...
     */
    public DefaultFeaturesExtractor() {
        super(DfaRun.UNMATCHED_COPY);
    }
    ...
    private DefaultAction text_action = new DefaultAction() {
        ...
        public void execute(StringBuffer yytext, int start) {                
            ...
            // Get parsing from features config
            ...
            // Create CRF to get the feature pipe
            ...
            try {
                ...
                System.out.println("Error: An error ocurred while extracting features. " + ex.getMessage());
            }          
