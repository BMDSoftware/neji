 ...
 * @author jeronimo
 */
public class TrainPipelinePhase2 extends BasePipeline {
     ...
     * Constructor.
     */
    public TrainPipelinePhase2() {
        super();
        this.trainer = null;
        setValidator(new TrainPipelinePhase2Validator(this));
    }
     ...
     */
    public TrainPipelinePhase2(Corpus corpus) {
        super(corpus);
        this.trainer = null;
        setValidator(new TrainPipelinePhase2Validator(this));
    }
    ...
    @Override
    protected List<OutputStream> run_(InputStream tmpInput) throws NejiException {
        ...
        try {
            ...
            // Sets the corpus path input stream in the specified InputStream
            ReaderCharSource cs = new ReaderCharSource(tmpInput, "UTF-8");
            previous.setIn(cs);
    ...
    @Override
    protected void run_(final InputStream corpusPathInput, final List<OutputStream> outputList) throws NejiException {
       
        // Output List will be ignored, in training
        this.run_(corpusPathInput);
    }   
