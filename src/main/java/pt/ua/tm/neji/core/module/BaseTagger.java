...
public abstract class BaseTagger extends BaseModule implements Tagger {
    ...
    public BaseTagger(final DfaRun.FailedMatchBehaviour failedBehaviour) {
        super(failedBehaviour);
    }

//    public BaseTagger(final Corpus corpus, final DfaRun.FailedMatchBehaviour failedBehavior) {
