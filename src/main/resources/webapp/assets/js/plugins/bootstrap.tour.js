    ...
    Tour = (function() {
      ...
      function Tour(options) {
        ...
        this._options = $.extend({
          ...
          styles: {
            prevCls: 'btn btn-mini',
            nextCls: 'btn btn-mini btn-primary',
            endCls: 'btn btn-mini'
          },
          keyboard: true,
      ...
      Tour.prototype._showPopover = function(step, i) {
        var content, nav, options, tip,
          _this = this;
        content = '' + step.content + '<nav class="clearfix"><div class="btn-group pull-left">';
        ...
        nav = [];
        if (step.prev >= 0 && step.showPrev) {
          nav.push("<a href='#" + step.prev + "' data-bypass class='prev " + options.styles.prevCls + "'>" + options.labels.prev + "</a>");
        }
        if (step.next >= 0 && step.showNext) {
          nav.push("<a href='#" + step.next + "' data-bypass class='next " + options.styles.nextCls + "'>" + options.labels.next + "</a>");
        }
        content += nav.join("") + '</div>';
        if (step.showEnd) {
          content += "<a href='#' data-bypass class='pull-right end " + options.styles.endCls + "'>" + options.labels.end + "</a>";
        }
        content += "</nav>";
